<?php get_header(); ?> 
                  <?php /* If this is a category archive */ if (is_category()) { ?>
                    <div class="pagetitle"><?php printf(__('Projects in the &#8216;%s&#8217; Category'), single_cat_title('', false)); ?></div>
                  <?php /* If this is a tag archive */ } elseif( is_tag() ) { ?>
                    <div class="pagetitle"><?php printf(__('Posts Tagged &#8216;%s&#8217;'), single_tag_title('', false) ); ?></div>
                  <?php /* If this is a daily archive */ } elseif (is_day()) { ?>
                    <div class="pagetitle"><?php printf(_c('Projects for %s|Daily archive page'), get_the_time(__('F jS, Y'))); ?></div>
                  <?php /* If this is a monthly archive */ } elseif (is_month()) { ?>
                    <div class="pagetitle"><?php printf(_c('Projects for %s|Monthly archive page'), get_the_time(__('F, Y'))); ?></div>
                  <?php /* If this is a yearly archive */ } elseif (is_year()) { ?>
                    <div class="pagetitle"><?php printf(_c('Projects for %s|Yearly archive page'), get_the_time(__('Y'))); ?></div>
